...
export type ChangeIsRemember = IActionType<ActionType.CHANGE_WHETHER_REMEMBER, { IsRemember: boolean }>

export type ReducerActionType = SendLoginRequestAction | ChangeLoginStatusAction | ChangeAuthDataAction | ChangeIsRemember
